...
if TYPE_CHECKING:
    ...
    VLLM_TRITON_MAMBA_USE_TD: bool | None = None
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Tri-state TD toggle for the Mamba chunk-cumsum Triton kernel (parallels
    # VLLM_TRITON_ATTN_USE_TD): unset -> auto (on for XPU); ``1`` forces on;
    # ``0`` forces off.
    "VLLM_TRITON_MAMBA_USE_TD": lambda: {"1": True, "0": False}.get(
        os.getenv("VLLM_TRITON_MAMBA_USE_TD", "").strip()
    ),
